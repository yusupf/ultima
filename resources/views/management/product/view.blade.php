                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Title</label>
                                <div>
                                    <input name="title" class="form-control" value="{{ $product->title }}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Description</label>
                                <div>
                                    <textarea name="description" id="" cols="30" class="form-control" rows="5" readonly>{{ $product->description }}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                        ...
                        @foreach($link as $row)
                            <tr>
                                <td><input name="" class="form-control" value="{{ $row->link }}" readonly/></td>
                                <td><input name="" class="form-control" value="{{ $row->merchant }}" readonly/></td>
                                <td></td>
                            </tr>
                            @endforeach
                        </tbody>
